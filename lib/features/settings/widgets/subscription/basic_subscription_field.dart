...
class BasicSubscriptionField extends StatelessWidget {
  const BasicSubscriptionField({super.key});
      ...
      child: Row(
        children: [
          ...
          const Column(
            ...
            children: [
              Text("Basic Plan", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15),), 
