    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            children: [
              SettingMenu(headIcon: Icons.person, menuTitle: "Your Account", onTap: () {},),
              const SizedBox(height: 20,),
              SettingMenu(headIcon: Icons.attach_money, menuTitle: "Currency", onTap: () {},),
              const SizedBox(height: 20,),
              SettingMenu(headIcon: Icons.language, menuTitle: "Language", onTap: () {},),
              const SizedBox(height: 20,),
